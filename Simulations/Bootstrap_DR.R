pe.dr_boot <- function (ID,odata,prob,scenario, normalize=FALSE) {
  data<-odata[ID,]
  t<-data$z
...
DR_boot<-function(data,prob=0.5,scenario,B=500,normalize=FALSE){
  data<-as.data.frame(data)
  n<-dim(data)[1]
  ID<-matrix(sample(1:n,B*n,replace=TRUE),B,n)
  system.time(dd<-apply(ID,1,pe.dr_boot,odata=data,prob,scenario,normalize))
  bsd<-apply(dd,1,sd)
  return(bsd)
}
library(parallel)
cl<-makeCluster(detectCores())
clusterExport(cl,c("pe.dr_boot","optim","glm","DR_boot"))
set.seed(123456)
p=0.95
#data=1A
system.time(A1_QTE1<-parApply(cl,simdata1A,2,DR_boot,prob=p,scenario="1A",normalize=FALSE))
system.time(A1_QTE2<-parApply(cl,simdata1A,2,DR_boot,prob=p,scenario="2A",normalize=FALSE))
system.time(A1_QTE3<-parApply(cl,simdata1A,2,DR_boot,prob=p,scenario="1B",normalize=FALSE))
system.time(A1_QTE4<-parApply(cl,simdata1A,2,DR_boot,prob=p,scenario="2B",normalize=FALSE))#INCORRECT
apply(A1_QTE1,1,mean)
apply(A1_QTE2,1,mean)
apply(A1_QTE3,1,mean)
apply(A1_QTE4,1,mean)
#data=2A
system.time(A2_QTE1<-parApply(cl,simdata2A,2,DR_boot,prob=p,scenario="1A",normalize=FALSE))
system.time(A2_QTE2<-parApply(cl,simdata2A,2,DR_boot,prob=p,scenario="2A",normalize=FALSE))
system.time(A2_QTE3<-parApply(cl,simdata2A,2,DR_boot,prob=p,scenario="1B",normalize=FALSE))#INCORRECT
system.time(A2_QTE4<-parApply(cl,simdata2A,2,DR_boot,prob=p,scenario="2B",normalize=FALSE))
apply(A2_QTE1,1,mean)
apply(A2_QTE2,1,mean)
apply(A2_QTE3,1,mean)
apply(A2_QTE4,1,mean)
#data=2B
system.time(B2_QTE1<-parApply(cl,simdata2B,2,DR_boot,prob=p,scenario="1A",normalize=FALSE))#INCORRECT
system.time(B2_QTE2<-parApply(cl,simdata2B,2,DR_boot,prob=p,scenario="2A",normalize=FALSE))
system.time(B2_QTE3<-parApply(cl,simdata2B,2,DR_boot,prob=p,scenario="1B",normalize=FALSE))
system.time(B2_QTE4<-parApply(cl,simdata2B,2,DR_boot,prob=p,scenario="2B",normalize=FALSE))
apply(B2_QTE1,1,mean)
apply(B2_QTE2,1,mean)
apply(B2_QTE3,1,mean)
apply(B2_QTE4,1,mean)
#data=1B
system.time(B1_QTE1<-parApply(cl,simdata1B,2,DR_boot,prob=p,scenario="1A",normalize=FALSE))
system.time(B1_QTE2<-parApply(cl,simdata1B,2,DR_boot,prob=p,scenario="2A",normalize=FALSE))#INCORRECT
system.time(B1_QTE3<-parApply(cl,simdata1B,2,DR_boot,prob=p,scenario="1B",normalize=FALSE))
system.time(B1_QTE4<-parApply(cl,simdata1B,2,DR_boot,prob=p,scenario="2B",normalize=FALSE))
...
p=0.5
#data=1B
system.time(C3_QTE1_sd<-parApply(cl,simdata3C,2,DR_boot,prob=p,scenario="1A",normalize=FALSE))
system.time(C3_QTE2_sd<-parApply(cl,simdata3C,2,DR_boot,prob=p,scenario="2A",normalize=FALSE))
system.time(C3_QTE3_sd<-parApply(cl,simdata3C,2,DR_boot,prob=p,scenario="1B",normalize=FALSE))
system.time(C3_QTE4_sd<-parApply(cl,simdata3C,2,DR_boot,prob=p,scenario="2B",normalize=FALSE))
apply(C3_QTE1_sd,1,mean)
apply(C3_QTE2_sd,1,mean)
apply(C3_QTE3_sd,1,mean)
apply(C3_QTE4_sd,1,mean)
save(C3_QTE1_sd,C3_QTE2_sd,C3_QTE3_sd,C3_QTE4_sd,
     file="/u5/y63xie/MacProfile/project3/datasim5/200/BSD_DR_C3.Rdata")
...
save(A1_QTE1,A1_QTE2,A1_QTE3,A1_QTE4,B1_QTE1,B1_QTE2,B1_QTE3,B1_QTE4,
     ...
     file="/u5/y63xie/MacProfile/project3/datasim5/BSD_DR_0.95.Rdata")
save(B1_QTE1,B1_QTE2,B1_QTE3,B1_QTE4,file="/u5/y63xie/MacProfile/project3/datasim5/bootstrap/BSD_DR_0.95.Rdata")


load("N:/MacProfile/project3/datasim5/bootstrap/BSD_DR.Rdata")
load("/u5/y63xie/MacProfile/project3/datasim5/bootstrap/BSD_DR_0.25.Rdata")
load("N:/MacProfile/project3/datasim5/bootstrap/BSD_DR_0.75.Rdata")
load("N:/MacProfile/project3/datasim5/bootstrap/BSD_DR_0.95.Rdata")
load("N:/MacProfile/project3/datasim5/200/BSD_DR.Rdata")
...
load("N:/MacProfile/project3/datasim5/q_0.95/DR.Rdata")
load("N:/MacProfile/project3/datasim5/200/DR.Rdata")
